...
class NotSoSmallLSTM(GeneralLSTM):
    ...
    def create_model(self):
        ...
        returns_features = concatenate([
            market_returns_input, market_kurt_returns_input,
            return_diff_to_market_input, returns_input, eqt_avg_returns_input,
            eqt_kurt_returns_input
        ])
        ...
        eqt_market_returns = Dense(
            128, activation='linear')(eqt_market_returns)
        ...
        model = Model(
            inputs=[
                ...
                return_diff_to_market_input, market_kurt_returns_input,
                eqt_avg_returns_input, eqt_kurt_returns_input
            ],
            outputs=[output])

        inputs = [
            "eqt_code_input", "nb_eqt_traded", "nb_nans_data", "returns_input",
            "market_returns_input", "return_diff_to_market_input",
            "market_kurt_returns", "eqt_avg_returns", "eqt_kurt_returns"
        ]
        return model, inputs
